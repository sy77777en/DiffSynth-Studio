...
class ActionConditioningConfig:
    ...
    The three conditioning streams (action, mask, history) each have an
    ...
    # Raw action feature size (e.g. 14-dim delta actions from EVAC or 7-dim from single arm robots)
    action_dim: int = 14
    ...
    mask: ConditionStreamConfig = field(
        default_factory=lambda: ConditionStreamConfig(
